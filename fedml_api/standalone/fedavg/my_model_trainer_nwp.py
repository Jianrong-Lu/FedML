...
class MyModelTrainer(ModelTrainer):
    ...
    def train(self, round_idx, train_data, device, args, last_model_dict, client_model, original_model, vec_loc):
        model = self.model
        ...
        for epoch in range(args.epochs):
            ...
            for batch_idx, (x, labels) in enumerate(train_data):
                ...
                print("x.size = " + str(x.size()),"labels.size = " + str(labels.size()))
                model.zero_grad()
                log_probs = model(x)

...
def load_poisoned_dataset(args):
    ...
    if args.dataset in ("mnist", "femnist"):
        ...
        fraction = 0.1 #10
        with open("./../../../data/edge_case_examples/ARDIS/poisoned_dataset_fraction_{}".format(fraction), "rb") as saved_data_file:
        ...
        # print(poisoned_dataset.data.shape)
        # print(emnist_train_dataset.data.shape)
        ...
        print(ardis_test_dataset.data.shape)
        ...
        if args.poison_type == "southwest":
            ...
            print("poisoned_trainset.data.shape[0]",poisoned_trainset.data.shape[0])
            ...
            poisoned_trainset.data = np.append(poisoned_trainset.data, saved_southwest_dataset_train, axis=0)#400clear data 与 100 edge case mixture

...
def get_dataloader(dataset, datadir, train_bs, test_bs, device,dataidxs=None):
    return get_dataloader_cinic10(datadir, train_bs, test_bs, device,dataidxs)
...
def get_dataloader_cinic10(datadir, train_bs, test_bs, device,dataidxs=None):
...
def load_partition_data_cinic10(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size,device):
    X_train, y_train, X_test, y_test, net_dataidx_map, traindata_cls_counts = partition_data(dataset,
                                                                                             data_dir,
                                                                                             partition_method,
                                                                                             client_number,

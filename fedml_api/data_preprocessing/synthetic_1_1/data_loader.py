...
def load_partition_data_federated_synthetic_1_1(data_dir, batch_size):
    logging.info("load_partition_data_federated_synthetic_1_1 START")
    train_file_path = data_dir + "/train/mytrain.json"
    test_file_path = data_dir + "/test/mytest.json"
...
def test_data_loader():
    client_num, train_data_num, test_data_num, train_data_global, test_data_global, \
        data_local_num_dict, train_data_local_dict, test_data_local_dict, output_dim = load_partition_data_federated_synthetic_1_1()

...
def load_centralized_data_shakespeare(train_batch_size,test_batch_size):
    # train_path = "../../../data/shakespeare/train"
    # test_path = "../../../data/shakespeare/test"
    train_path = "../../data/shakespeare/train"
    test_path = "../../data/shakespeare/test"
    ...
    for u, g in zip(users, groups):
        ...
        # transform to batches
        train_batch = batch_data(train_data[u], train_batch_size)
        test_batch = batch_data(test_data[u], test_batch_size)
